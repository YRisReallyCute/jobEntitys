...
class ZyybdappPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        self.cursor.execute("""select 
                info_ym,info_bm,info_cf,info_zffx,info_gnzz,info_zbff,info_jxgg,info_yfyl,info_zlbz,info_syjj,info_zysx,info_xdyj,info_lcyy,info_fg,info_qtzj,info_zc,info_lj,info_blfy,info_yldl,info_ywxhzy,info_fl,info_zxbz,info_qt
        ...
        if (insertOrNot != self.noRefresh):
            ...
            #                 ,origin_url,create_time,update_time,origin_body，status)
            #                 value(%s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s,%s,%s,%s)""",
            #     (
            self.cursor.execute(
                """insert into yy_data1."""+sourcedb+"""(id,info_ym,info_bm,info_cf,info_zffx,info_gnzz,info_zbff,info_jxgg,info_yfyl,info_zlbz,info_syjj,info_zysx,info_xdyj,info_lcyy,info_fg,info_qtzj,info_zc,info_lj,info_blfy,info_yldl,info_ywxhzy,info_fl,info_zxbz
