...
class YaobiaowPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        self.cursor.execute("""select 
                        info_ym,info_cf,info_fl,info_zffx,info_gnzz,info_zbff,info_jxgg,info_yfyl,info_zlbz,info_zysx,info_xdyj,info_lcyy,info_blfy,info_qtzj,info_fg,info_zc,info_lj,info_qt
